...
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-pcsv)'
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-pdf-tools)'
...
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-plz)'
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-poetry)'
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-pos-tip)'
...
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-smeargle)'
...
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-treepy)'
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-wfnames)'
guix build -c 24 -L ./src -e '(@(bost gnu packages emacs-xyz-new) emacs-yapfify)'
