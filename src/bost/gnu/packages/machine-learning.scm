...
(define-module (bost gnu packages machine-learning)
...
(define-public llama-cpp
  (let ((tag "9309"))                  ;sync with ggml and python-gguf
    (package
      (name "llama-cpp")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "13862h99l6hccwip6rcf9zi0352w0njcdi9hwz61w61w7n0yr70l"))))
      (build-system cmake-build-system)
      (arguments
       (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "18i6lsbs0vhnphn9l7sxryd977nby6pnjg07y9rhbq1v10vpcq1m"))))
    (build-system gnu-build-system)
    (arguments
     (list
      #:tests? #f                       ;no tests
                ...
                (let ((bin (string-append #$output "/bin")))
                  (for-each
                   ...
                   (append (list "koboldcpp.py"
                           ...
                           (find-files "." "\\.so$")))
                  (chmod (string-append bin "/koboldcpp.py") #o555))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1pfk4mdkvm75lyyb7zmq9pxclhica7fkk4cyvkpz8jncgimvh5qs"))))
    (build-system pyproject-build-system)
...
(define-public python-botorch
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1flb6fv2m6l8bbmbq9n7lgf1fd45r9xx2rw08qanm1c00dv12s99"))))
    (build-system pyproject-build-system)
    (arguments
