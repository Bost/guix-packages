...
(define-public emacs-spacemacs-base
  (let ((commit
         ;; "771273532cab7736f5cd1c93755e80ddf0dfe4f7"
         "372ecae2b8ea84ada4c3aa0acad6d2ad4eac0c46"
         )
        (revision "0"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           ;; "0y320njc07pdisvlcc5gyad2is9x3gwz0pdkgrmzzdk2xsdcrb05"
           "0qsb8vxkr9bnv5mpfb7p2nxxhnkjfwzqflcr6a9jc18rhc2lzq4l"
           ))))
      (build-system emacs-build-system)
      (arguments
       (list
...
(define-public emacs-clipetty
  (let ((commit "01b39044b9b65fa4ea7d3166f8b1ffab6f740362")
        (revision "0"))
      (package
        (name "emacs-clipetty")
        (version (git-version "0.0.2" revision commit))
        (source
         (origin
           ...
           (file-name (git-file-name name version))
           (sha256
            (base32 "1g1awdcqzrnw1a6gl4n87a97lniyn0ck5a51l9n6jz2m8k3idmsg"))))
        (build-system emacs-build-system)
...
(define (emacs-lsp-mode-package-files)
  "Returns a quoted list.
LSP Mode - LSP support for Emacs Supported languages:
https://emacs-lsp.github.io/lsp-mode/page/languages/

AWK:
M-x lsp-install-server <RET> awkls <RET>
...
Emacs lisp:
https://github.com/elisp-lsp/ellsp ; 60 stars
https://github.com/emacs-elsa/Elsa ; 703 stars
...
"
  '(list
    ...
    ;; "lsp-autotools"
    "lsp-awk"
    "lsp-bash"          ; https://emacs-lsp.github.io/lsp-mode/page/lsp-bash/
    ;; "lsp-beancount"
    ;; "lsp-bufls"
    ;; "lsp-c3"
    ;; "lsp-camel"
    ...
    (arguments
     (list
      ...
      #~(modify-phases %standard-phases
          ...
          (add-after 'ensure-package-description 'add-needed-pkg-descriptions
            (lambda* (#:key outputs #:allow-other-keys)
              (map bst:write-pkg-file #$(emacs-lsp-mode-package-files)
                   ))))))
    (propagated-inputs
     (list
      bst:emacs-dash
...
(define-public emacs-spacemacs
  (let ((commit
         ...
         "5567545aac8c87aef7b13ab31e8461672f903cb8" ; spgx-squashed
         )
        (revision "0"))
    (package
       ...
       (origin
         ...
         (sha256
          (base32
           ...
           "0jr12681i9ccycf7a6xv9m0gsqwj1sfcp4bh9h7hpgjk63jzmwzi" ; spgx-squashed
           ))))
      (build-system emacs-build-system)
      (arguments
       (list
...
;; variants of emacs-dash, emacs-el-mock, emacs-f, emacs-undercover and
;; emacs-ert-runner, which are referenced through the bst: prefix.  Each
;; definition below is the upstream Guix version with those inputs re-prefixed;
...
(define-public emacs-ansible
  (package
    ...
    (build-system emacs-build-system)
    (propagated-inputs (list bst:emacs-f emacs-s))
...
(define-public emacs-attrap
  (package
    ...
    (build-system emacs-build-system)
    (propagated-inputs
     (list bst:emacs-dash bst:emacs-f emacs-flycheck emacs-s))
...
(define-public emacs-calibredb
  (package
    ...
    (inputs
     (list calibre))
    (propagated-inputs
     (list bst:emacs-dash emacs-esxml emacs-request emacs-s))
...
(define-public emacs-cfrs
  (package
    ...
    (build-system emacs-build-system)
    (propagated-inputs
     (list bst:emacs-dash emacs-posframe emacs-s))
...
(define-public emacs-clojure-mode
  (package
    ...
    (build-system emacs-build-system)
    (native-inputs
     (list emacs-buttercup bst:emacs-dash emacs-paredit emacs-s))
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0yql0k5bw1vsqh44g5aq6ip6dn3c36k8gpljvbghsj01fcqdlvj6"))))
    (inputs
     (list bst:emacs-undercover))
    (propagated-inputs
     (list emacs-aio
           bst:emacs-dash
           emacs-json-mode
                ...
                (substitute* "test/dumb-jump-test.el"
                  (("\\(ert-deftest dumb-jump-([a-z0-9-]*) \\(\\)" all test)
                   (if (member test skip-tests)
                       ...
                       all)))))))))
    (native-inputs
     (list bst:emacs-el-mock
           bst:emacs-ert-runner
           bst:emacs-f
           emacs-noflet
           bst:emacs-undercover))
    (propagated-inputs
     (list bst:emacs-dash emacs-s emacs-popup))
...
(define-public emacs-elfeed-protocol
  (package
    ...
    (propagated-inputs
     (list emacs-elfeed))
    (native-inputs (list bst:emacs-ert-runner))
...
(define-public emacs-epkg
  (package
    ...
    (native-inputs
     (list texinfo))
    (propagated-inputs
     (list emacs-closql bst:emacs-dash emacs-llama))
...
(define-public emacs-ht
  ...
  (let ((commit "1c49aad1c820c86f7ee35bf9fff8429502f60fef")
    ...
    (package
      ...
      (build-system emacs-build-system)
      (propagated-inputs (list bst:emacs-dash))
      (native-inputs
       (list bst:emacs-ert-runner))
...
(define-public emacs-julia-snail
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1p00j4lh9nhkim0lg1f0swvv5lsn54w9qk1g2pjxldrfsad7bqwg"))))
    (build-system emacs-build-system)
    (arguments
     (list
      #:include
...
(define-public emacs-org-roam
  (package
    ...
    (inputs
     (list graphviz))
    (native-inputs
     (list bst:emacs-ert-runner texinfo))
    (propagated-inputs
     (list bst:emacs-dash
           emacs-emacsql
           emacs-magit))
...
(define-public emacs-org-wild-notifier
  (package
    ...
    (build-system emacs-build-system)
    (propagated-inputs
     (list bst:emacs-dash emacs-alert emacs-async))
    (license license:gpl3+)
...
(define-public emacs-orgit
  (package
    ...
    (propagated-inputs
     (list bst:emacs-dash emacs-magit))
...
(define-public emacs-orgmdb
  (package
    ...
    (inputs
     (list fd))
    (propagated-inputs
     (list bst:emacs-dash emacs-org emacs-s))
...
(define-public emacs-pandoc-mode
  (package
    ...
    (build-system emacs-build-system)
    (propagated-inputs
     (list bst:emacs-dash emacs-hydra))
  ...
  (package
    ...
    (arguments
     (list #:test-command #~(list "emacs" "--batch"
                                  ...
                                  "-f" "ert-run-tests-batch-and-exit")))
    (propagated-inputs
     (list bst:emacs-dash emacs-hcl-mode))
