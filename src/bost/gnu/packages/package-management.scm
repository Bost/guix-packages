...
(define-module (bost gnu packages package-management)
  ...
  (let ((version "1.4.0")
    ...
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0iy2s500dx7yhzvzz7zch5nsj71vcz0cd1rxvw3icvqlgbpj1alc"))
...
#|
# default
sudo /gnu/store/q73gdvhna0dj9cxqp2dwfg48drpn0k68-flatpak-1.16.0/bin/flatpak   update

# wrapped by GSETTINGS_SCHEMA_DIR="/gnu/store/...",                 gtk+ among flatpak package-inputs
sudo /gnu/store/rf906mq99am83j04lyax8yv9jcg0bp8s-flatpak-1.16.0-1/bin/flatpak update

# wrapped by GSETTINGS_SCHEMA_DIR="/gnu/store/...:/gnu/store/..." ; gtk+, gsettings-desktop-schemas among flatpak package-inputs
sudo /gnu/store/qx0brspia55f3bf9aca7d2z3b5qdjpyr-flatpak-1.16.0-2/bin/flatpak update

# wrapped by GSETTINGS_SCHEMA_DIR="/gnu/store/..." ;                gsettings-desktop-schemas among flatpak package-inputs
sudo /gnu/store/ffq7kcn93kb8pp7wymckrdj9gjhkpy8a-flatpak-1.16.0-3/bin/flatpak update
...
;; PR sent. See https://issues.guix.gnu.org/77735 77735@debbugs.gnu.org
